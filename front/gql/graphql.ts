...
export type GetProjectQuery = { __typename?: 'Query', getProjectById: { __typename?: 'Project', description: string, title: string, codeSnippetsOwned: Array<{ __typename?: 'CodeSnippet', code: string, id: string, language: Language, title: string }>, owner: { __typename?: 'User', username: string, id: string, email: string } } };
