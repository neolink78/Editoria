...
export type GetProjectsQuery = { __typename?: 'Query', getProjects: Array<{ __typename?: 'Project', id: string, createdAt: any, title: string, description: string, owner: { __typename?: 'User', id: string, email: string, username: string }, comments: Array<{ __typename?: 'Comment', id: string, content: string }>, codeSnippetsOwned: Array<{ __typename?: 'CodeSnippet', id: string, language: Language }>, likes: Array<{ __typename?: 'Like', id: string }> }> };
